...
(function (factory) {
  ...
  $(function() {  
    $("html").niceScroll({
        ...
        // cursoropacitymin:.5,
        // cursorwidth: "15px",
        // cursorborder: "4px dashed blue", 
        // cursorborderradius:"20px",
        scrollspeed: 100,
        mousescrollstep: 100,
        zindex:"auto",//[9999]
        touchbehavior: false,//화면 터치로 드래그하기
        emulatetouch: false, //화면 터치로 드래그하기
        hwacceleration: false, //하드웨어 가속
        autohidemode: false, // 스크롤바 숨길지 말지 ( flase : 안숨김 , "scroll" : 스크롤시에만 보임)
        background: "",//스크롤 레일 색상지정
